...
public class TimezoneService {
    ...
    public void updateTimezone(TimeZoneDataModel timeZoneDataModel) {
        ...
        existingValue.setCity(updatedValue.getCity());
        existingValue.setHourdiff(updatedValue.getHourdiff());
        existingValue.setMindiff(updatedValue.getMindiff());

        timezoneRepository.saveAndFlush(existingValue);
    }
