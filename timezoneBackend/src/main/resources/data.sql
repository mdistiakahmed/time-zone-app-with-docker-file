...
create table t_timezone (id serial PRIMARY KEY, name varchar(255),city varchar(255),hourdiff INT,mindiff INT, email varchar(255), version INT, FOREIGN KEY (email) REFERENCES t_user (email));
